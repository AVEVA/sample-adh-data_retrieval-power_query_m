...
| GetDataView.pq | Retrieves the data of a single Data View. Please note that this function makes calls for interpolated data. The query could be changed to retrieve stored values.                                                                                                           |
